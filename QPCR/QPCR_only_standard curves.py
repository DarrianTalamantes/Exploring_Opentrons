...
def run(protocol: protocol_api.ProtocolContext):
    ...
    tube_rack1 = protocol.load_labware('opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap', tube_rack_dilutions)
    ...
    # Loading the water 
        for p in range(0, Primers):
            deposit_loc = get_deposit_location(p, 15, plate_array)
            left_pipette.transfer(5, tube_rack1.wells_by_name()[water_loc],

...
def run(protocol: protocol_api.ProtocolContext):
    ...
    current_tip_200 = 2  # Where the P300 multi should start on tip_rack_200ul_1
    ...
    tip_rack_200ul_1 = protocol.load_labware('opentrons_96_filtertiprack_20ul', tip_rack_200ul_loc1)
    ...
    # Set starting tip
    right_pipette.starting_tip = tip_rack_200ul_loc1.wells()[current_tip_200]
    ...
    for col in range(0, cloumns_loaded):
        right_pipette.transfer(sample_amount, sample_96_plate.columns(col), dilution_plate.columns(col),
                               mix_before=(2, 50), air_gap=10,  mix_after=(3, 75))

    # # Transfer 5ul of diluted sample to black plate and mix
    for col in range(0, cloumns_loaded):
        right_pipette.transfer(5, dilution_plate.columns(col), black_plate.columns(col),
                               air_gap=10,  mix_after=(5, 100))
